...
Сверено с Alembic-ревизией `20260621_0004` и текущими SQLAlchemy-моделями.
...
- Для промокода дата старта проверяется в прикладной логике: не раньше следующего бизнес-дня и не позже трёх календарных месяцев от текущей даты.
- Для комплекта дата старта проверяется в прикладной логике: не раньше следующего бизнес-дня.
